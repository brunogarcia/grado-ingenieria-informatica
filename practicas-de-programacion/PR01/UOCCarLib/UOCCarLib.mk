...
ProjectPath            :=/home/bruno/UOC/pract01/UOCCarLib
...
$(OutputFile): $(Objects)
	...
	@$(MakeDirCommand) "/home/bruno/UOC/pract01/.build-debug"
	@echo rebuilt > "/home/bruno/UOC/pract01/.build-debug/UOCCarLib"
...
$(IntermediateDirectory)/src_helpers.c$(ObjectSuffix): src/helpers.c $(IntermediateDirectory)/src_helpers.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/bruno/UOC/pract01/UOCCarLib/src/helpers.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_helpers.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_operations.c$(ObjectSuffix): src/operations.c $(IntermediateDirectory)/src_operations.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/bruno/UOC/pract01/UOCCarLib/src/operations.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_operations.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_cars.c$(ObjectSuffix): src/cars.c $(IntermediateDirectory)/src_cars.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/bruno/UOC/pract01/UOCCarLib/src/cars.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_cars.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_offices.c$(ObjectSuffix): src/offices.c $(IntermediateDirectory)/src_offices.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/bruno/UOC/pract01/UOCCarLib/src/offices.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_offices.c$(ObjectSuffix) $(IncludePath)
